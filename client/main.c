...
void printClientInterface() {
    ...
    printf("%s2 - write%s\n", ANSI_COLOR_RESET, ANSI_COLOR_RESET);
    usleep(10000);
    printf("%s3 - get information%s\n", ANSI_COLOR_RESET, ANSI_COLOR_RESET);
    usleep(10000);
    printf("%s4 - streaming%s\n", ANSI_COLOR_RESET, ANSI_COLOR_RESET);
    usleep(10000);
    printf("%s5 - create file%s\n", ANSI_COLOR_RESET, ANSI_COLOR_RESET);
    usleep(10000);
    printf("%s6 - delete file%s\n", ANSI_COLOR_RESET, ANSI_COLOR_RESET);
    usleep(10000);
    printf("%s7 - create folder%s\n", ANSI_COLOR_RESET, ANSI_COLOR_RESET);
    usleep(10000);
    printf("%s8 - delete folder%s\n", ANSI_COLOR_RESET, ANSI_COLOR_RESET);
    usleep(10000);
    printf("%s9 - copy%s\n", ANSI_COLOR_RESET, ANSI_COLOR_RESET);
    usleep(10000);
    printf("%s10 - list%s\n", ANSI_COLOR_RESET, ANSI_COLOR_RESET);
...
int checkOption(int client_fd, int option) {
    ...
    if(option >= 1 && option <= 4) {
        ...
        if(ssDetails.status == -3){
             printf("%s Server is down contact%s\n", ANSI_COLOR_RED, ANSI_COLOR_RESET);
            return 0;
        }
        else {
